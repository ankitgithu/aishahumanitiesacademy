...
import MpBoard from "../assets/Mpboard/MpBoardResult";
import { motion, AnimatePresence } from "framer-motion";

const MpResult = () => {
  const [items, setItems] = useState(MpBoard);
  ...
  return (
    <>
      <h1 className="font-bold text-center text-6xl m-4">Our Priders <strong>MP Board</strong></h1>
        ...
        {selectedItem && (
          ...
          >
            ...
            >
              ...
              <table className="w-full border-collapse text-white border border-gray-400">
                <tbody>
                  <tr>
